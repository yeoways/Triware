...
from cv.networks import inception_utils
...
def inception_v3_base(inputs,
  ...
  concat_axis_index = 1 if data_format == 'NCHW' else 3
  ...
  with tf.variable_scope(scope, 'InceptionV3Base', [inputs]):
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                        stride=1, padding='VALID', data_format=data_format):
      # 299 x 299 x 3
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('Branch_3'):
          ...
          branch_3 = slim.conv2d(branch_3, depth(32), [1, 1],
                                 scope='Conv2d_0b_1x1')
        net = tf.concat(axis=concat_axis_index,
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0 = slim.conv2d(net, depth(64), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1 = slim.conv2d(net, depth(48), [1, 1], scope='Conv2d_0a_11')
          branch_1 = slim.conv2d(branch_1, depth(64), [5, 5],
                                 scope='Conv2d_0b_5x5')
        with tf.variable_scope('Branch_2'):
          branch_2 = slim.conv2d(net, depth(64), [1, 1], scope='Conv2d_0a_1x1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('Branch_1'):
          ...
          branch_1 = tf.concat(axis=concat_axis_index, values=[
        ...
        with tf.variable_scope('Branch_2'):
          ...
          branch_2 = tf.concat(axis=concat_axis_index, values=[
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with slim.arg_scope([slim.batch_norm], data_format=data_format):
        net, end_points = inception_v3_base(
            inputs, scope='InceptionV3Base', min_depth=min_depth,
      ...
      with tf.variable_scope('Logits'):
        ...
        logits = slim.conv2d(net, num_classes, [1, 1], activation_fn=None,
                             ...
                             data_format=data_format)
        if spatial_squeeze:
          squeeze_axis = [2, 3] if data_format == 'NCHW' else [1, 2]
          logits = tf.squeeze(logits, squeeze_axis, name='SpatialSqueeze')
        # 1000
